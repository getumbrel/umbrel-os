...
wget -qO- "https://raw.githubusercontent.com/getumbrel/umbrel/${UMBREL_VERSION_TAG}/install-box.sh" | sh
...
wget -q "https://raw.githubusercontent.com/getumbrel/umbrel/${UMBREL_VERSION_TAG}/docker-compose.yml"
