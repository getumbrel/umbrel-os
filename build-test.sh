...
docker exec -t dockerdebian bash -c 'apt-get update; apt-get install curl -y; ls /var/lib/docker; curl -fsSL https://get.docker.com -o get-docker.sh; ./get-docker.sh; docker --version; ls /var/lib/docker;'
